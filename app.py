...
def video_frame_callback(frame):
    ...
    if results.pose_landmarks:
        ...
        # 描画
        cv2.rectangle(img, (20, 20), (320, 160), (245, 117, 16), -1)
        cv2.putText(img, f"COUNT: {tracker['count']}", (40, 75), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 255, 255), 3, cv2.LINE_AA)
...
webrtc_streamer(
    ...
    media_stream_constraints={"video": {"width": {"ideal": 480}, "height": {"ideal": 640}, "facingMode": "user"}, "audio": False},
    video_html_attrs={"style": {"width": "100%", "aspect-ratio": "9 / 15", "object-fit": "cover"}, "autoPlay": True, "playsInline": True},
    async_processing=True,
)

st.metric(label="回数", value=f"{tracker['count']} 回")
if st.button("リセット"):
    tracker["count"] = 0
    st.rerun()